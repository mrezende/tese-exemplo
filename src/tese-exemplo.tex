...
\documentclass[14pt,twoside,a4paper]{extbook} % utilizando extbook para atender ao modelo do IPT

\usepackage{titlesec} % para alterar o tamanho da fonte das seções, subseções e capítulos
...
% alterando o tamanho da fonte para as seções de acordo com o guia do IPT
\titleformat{\chapter}[display]
  {\normalfont\normalsize\bfseries}{\chaptertitlename\ \thechapter}{14pt}{\Large}
\titleformat*{\section}{\normalsize\bfseries}
